...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ng_button.setOnClickListener {
            Toast.makeText(applicationContext, "NG", Toast.LENGTH_SHORT).show()
        }

        ok_image_button.setOnClickListener {
            Toast.makeText(applicationContext, "OK", Toast.LENGTH_SHORT).show()
        }
        ...
        color_text_enable_button.setOnClickListener {
            ...
            ng_button.isEnabled = !ng_button.isEnabled
            ok_image_button.isEnabled = !ok_image_button.isEnabled
